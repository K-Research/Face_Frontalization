...
X_train = np.load('D:/Taehwan Kim/Document/Bitcamp/Project/Frontalization/Numpy/color_28_x.npy') # Side face
# Y_train = np.load('D:/Bitcamp/Project/Frontalization/Numpy/color_128_y.npy') # Front face
Y_train = np.load('D:/Taehwan Kim/Document/Bitcamp/Project/Frontalization/Numpy/color_28_y.npy') # Front face

# print(X_train.shape)
# print(Y_train.shape)

X_test = np.load('D:/Taehwan Kim/Document/Bitcamp/Project/Frontalization/Numpy/lsm_x.npy') # Side face
# Y_test = np.load('‪D:/Bitcamp/Project/Frontalization/Numpy/lsm_y.npy') # Front face
Y_test_path = 'D:/Taehwan Kim/Document/Bitcamp/Project/Frontalization/Numpy/lsm_y.npy'
...
class DCGAN():
    ...
    def build_generator(self):
        ...
        conv2d_layer = Conv2D(filters = 3, kernel_size = (3, 3), strides = (1, 1), input_shape = (self.height, self.width, self.channels), padding = 'same')(side_face)

...
discriminator_optimizer = Adam(lr = 0.00002, beta_1 = 0.5, beta_2 = 0.999)
combine_optimizer = Adam(lr = 0.002, beta_1 = 0.5, beta_2 = 0.999)

X_train = glob("D:/Korean 224X224X3 filtering/X_train/*jpg")
Y_train = glob("D:/Korean 224X224X3 filtering/Y_train/*jpg")
...
class model_1():
    ...
    def __init__(self):
        ...
        self.DG = DataGenerator(X_train, Y_train, batch_size = batch_size, dim = (224, 224))
        self.number = number
        self.history = []
        ...
        self.combined.compile(loss = 'binary_crossentropy', optimizer = self.optimizerC)
    ...
    def train(self, epochs, batch_size, save_interval):
        ...
        for i in range(epochs):
            ...
            # for j in range(batch_size):
                ...
                record = (i + 1, j + 1, discriminator_loss[1] * 100, discriminator_loss[0], generator_loss)
            ...
            if i % 1 == 0:
                self.generator.save("D:/Generated Image/{1}_{0}.h5".format(str(i), str(line)))
                save_path = 'D:/Generated Image/Training' + str(line) + '/'
                self.save_image(epoch = i, batch = j, front_image = front_images, side_image = side_images, save_path = save_path)

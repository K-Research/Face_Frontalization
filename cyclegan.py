        ...
        for k in range(1, epochs + 1):
            for l in tqdm(range(self.batch)):
                ...
                print ('\nTraining epoch : %d \nTraining batch : %d \nAccuracy of discriminator : %.2f%% \nLoss of discriminator : %f \nLoss of generator : %f ' 
                        % (k, l, discriminator_B_loss * 100, discriminator_B_loss, generator_B_discriminator_loss_synthetic))

                record = (k, l, discriminator_B_loss * 100, discriminator_B_loss, generator_B_discriminator_loss_synthetic)

...
class DCGAN():
    ...
    def build_generator(self):
        ...
        input = Input(shape = self.channels)
        ...
        blue_layer = Dense(64 * 7 * 7)(blue_layer)
        blue_layer = Activation(paramertic_relu(alpha_initializer = 'zeros', alpha_regularizer = None, alpha_constraint = None, shared_axes = [1, 2]))(blue_layer)
        blue_layer = Reshape((7, 7, 64))(blue_layer)
        ...
        blue_layer = BatchNormalization(momentum = 0.8)(blue_layer)
        blue_layer = Activation(paramertic_relu(alpha_initializer = 'zeros', alpha_regularizer = None, alpha_constraint = None, shared_axes = [1, 2]))(blue_layer)
        blue_layer = Conv2D(self.channels, kernel_size = (3, 3), strides = (1, 1), padding = 'same')(blue_layer)
        ...
        green_layer = Dense(64 * 7 * 7)(green_layer)
        green_layer = Activation(paramertic_relu(alpha_initializer = 'zeros', alpha_regularizer = None, alpha_constraint = None, shared_axes = [1, 2]))
        green_layer = Reshape((7, 7, 64))(green_layer)
        ...
        green_layer = BatchNormalization(momentum = 0.8)(green_layer)
        green_layer = Activation(paramertic_relu(alpha_initializer = 'zeros', alpha_regularizer = None, alpha_constraint = None, shared_axes = [1, 2]))(green_layer)
        green_layer = Conv2D(self.channels, kernel_size = (3, 3), strides = (1, 1), padding = 'same')(green_layer)
        ...
        red_layer = Dense(64 * 7 * 7)(red_layer)
        red_layer = Activation(paramertic_relu(alpha_initializer = 'zeros', alpha_regularizer = None, alpha_constraint = None, shared_axes = [1, 2]))(red_layer)
        red_layer = Reshape((7, 7, 64))(red_layer)
        ...
        red_layer = BatchNormalization(momentum = 0.8)(red_layer)
        red_layer = Activation(paramertic_relu(alpha_initializer = 'zeros', alpha_regularizer = None, alpha_constraint = None, shared_axes = [1, 2]))(red_layer)
        red_layer = Conv2D(self.channels, kernel_size = (3, 3), strides = (1, 1), padding = 'same')(red_layer)

...
X = np.load('D:/Taehwan Kim/Document/Bitcamp/Project/Frontalization/Imagenius/Numpy/data_x.npy') # 
Y = np.load('D:/Taehwan Kim/Document/Bitcamp/Project/Frontalization/Imagenius/Numpy/data_y.npy')

X = X / 127.5 - 1
Y = Y / 127.5 - 1

height = X.shape[1] # 128
width = X.shape[2] # 128
channels = X.shape[3] # 3
z_dimension = 512
batch_size = 32
epochs = 10000
line = 1
        ...
        for i in range(epochs):
            for j in range(batch_size):
                ...
                if j % save_interval == 0:
                    ...
                    self.save_image(image_index = j, front_image = front_images, side_image = side_images, save_path = save_path)
...
if __name__ == '__main__':
    dcgan = G()
    dcgan.train(epochs = 10000, batch_size = 12, save_interval = 1)
...
# Load data
X_train = glob('D:/Bitcamp/Project/Frontalization/Imagenius/Data/128_X/*jpg')
Y_train = glob('D:/Bitcamp/Project/Frontalization/Imagenius/Data/128_Y/*jpg')

X_test = glob('D:/Bitcamp/Project/Frontalization/Imagenius/Data/128_X_test/*jpg')
Y_test = glob('D:/Bitcamp/Project/Frontalization/Imagenius/Data/128_Y_test/*jpg')
...
class Autoencoder():
    def __init__(self):
        ...
        self.datagenerator_predict = DataGenerator_predict(X_test, Y_test, batch_size = batch_size)
    ...
    def build_autoencoder(self):
        ...
        generator_layer = Conv2DTranspose(filters = 1024, kernel_size = (3, 3), strides = (2, 2), padding = 'valid')(generator_input) # (9, 9, 1024)
        generator_layer = BatchNormalization(momentum = 0.8)(generator_layer)
        generator_layer = LeakyReLU(alpha = 0.2)(generator_layer)
        generator_layer = Conv2DTranspose(filters = 512, kernel_size = (3, 3), strides = (1, 1), padding = 'valid')(generator_layer) # (11, 11, 512)
        generator_layer = BatchNormalization(momentum = 0.8)(generator_layer)
        generator_layer = LeakyReLU(alpha = 0.2)(generator_layer)
        generator_layer = Conv2DTranspose(filters = 512, kernel_size = (3, 3), strides = (1, 1), padding = 'valid')(generator_layer) # (13, 13, 512)
        generator_layer = BatchNormalization(momentum = 0.8)(generator_layer)
        generator_layer = LeakyReLU(alpha = 0.2)(generator_layer)
        generator_layer = Conv2DTranspose(filters = 512, kernel_size = (3, 3), strides = (2, 2), padding = 'valid')(generator_layer) # (27, 27, 512)
        generator_layer = BatchNormalization(momentum = 0.8)(generator_layer)
        generator_layer = LeakyReLU(alpha = 0.2)(generator_layer)
        generator_layer = Conv2DTranspose(filters = 256, kernel_size = (3, 3), strides = (1, 1), padding = 'valid')(generator_layer) # (29, 29, 256)
        generator_layer = BatchNormalization(momentum = 0.8)(generator_layer)
        generator_layer = LeakyReLU(alpha = 0.2)(generator_layer)
        generator_layer = Conv2DTranspose(filters = 256, kernel_size = (3, 3), strides = (2, 2), padding = 'valid')(generator_layer) # (59, 59, 256)
        generator_layer = BatchNormalization(momentum = 0.8)(generator_layer)
        generator_layer = LeakyReLU(alpha = 0.2)(generator_layer)
        generator_layer = Conv2DTranspose(filters = 128, kernel_size = (3, 3), strides = (1, 1), padding = 'valid')(generator_layer) # (61, 61, 128)
        generator_layer = BatchNormalization(momentum = 0.8)(generator_layer)
        generator_layer = LeakyReLU(alpha = 0.2)(generator_layer)
        generator_layer = Conv2DTranspose(filters = 128, kernel_size = (3, 3), strides = (1, 1), padding = 'valid')(generator_layer) # (63, 63, 128)
        generator_layer = BatchNormalization(momentum = 0.8)(generator_layer)
        generator_layer = LeakyReLU(alpha = 0.2)(generator_layer)
        generator_layer = Conv2DTranspose(filters = 128, kernel_size = (3, 3), strides = (2, 2), padding = 'valid')(generator_layer) # (127, 127, 128)
        generator_layer = BatchNormalization(momentum = 0.8)(generator_layer)
        generator_layer = LeakyReLU(alpha = 0.2)(generator_layer)
        generator_layer = Conv2DTranspose(filters = self.channels, kernel_size = (2, 2), strides = (1, 1), padding = 'valid')(generator_layer) # (128, 128, 3)

...
line = 300
n_show_image = 1
vgg = VGGFace(include_top=False, model="vgg16", weights= 'vggface', input_shape=(224, 224, 3))
vgg.trainable = False
...
class TestModel():
    ...
    def build_AE(self):
        ...
        layers = self.deconv2d_block(layers, 64)
        layers = self.deconv2d_block(layers, 32)
